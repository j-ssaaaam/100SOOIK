...
function StudentView(props: {
  ...
  const progressUnitOrder = progressSemester ? [...new Set(questions.filter((question) => question.grade === 6 && String(question.semester) === progressSemester && question.isPlayable).map((question) => question.unit))] : [];
