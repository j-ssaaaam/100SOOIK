...
function StudentView(props: {
  ...
  const units = [...new Set(questions.filter((question) => String(question.semester) === semester).map((question) => question.unit))];
  const selectedCatalogQuestion = questions.find((question) => String(question.semester) === semester && question.unit === selectedUnit && String(question.questionNumber) === selectedQuestionNumber) ?? null;
