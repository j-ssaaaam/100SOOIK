...
function StudentView(props: {
  ...
  const lessons = [...new Set(questions.filter((question) => String(question.semester) === semester && question.unit === selectedUnit).map((question) => question.lesson))];
  const selectedCatalogQuestion = questions.find((question) => String(question.semester) === semester && question.unit === selectedUnit && question.lesson === selectedLesson && String(question.questionNumber) === selectedQuestionNumber) ?? null;
