...
import { getCookie, isSupabaseConfigured, supabaseRest, supabaseUpdatePassword, supabaseUser } from "../../../../lib/supabase-rest";
...
export async function POST(request: Request) {
  ...
  if (isSupabaseConfigured()) {
    ...
    await supabaseUpdatePassword(accessToken, pin);
